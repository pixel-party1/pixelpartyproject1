...
class MemoryMatchHardModeViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    // MARK: - Card Setup
    func setupCards() {
        // 18 image names for 18 pairs
        let imageNames = ["card1",  "card2",  "card3",  "card4",  "card5",  "card6",
